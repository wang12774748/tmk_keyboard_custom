...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------|
     * |坏键|FN0|Sup |      Space            | Fn1  | Alt| Ctl|CAPS|
     * `-----------------------------------------------------------'
     */
    KEYMAP_HHKB(
        ...
        BSPC, FN0, LGUI,          SPC,                     FN1, LALT, RCTL, CAPS),
    ...
    KEYMAP_HHKB(
        ...
        TRNS,TRNS,SLCK,PAUS,TRNS,TRNS,   7,   8,   9,TRNS,PSCR,TRNS,TRNS,BSPC,      \
        TRNS,MUTE,VOLD,VOLU,EJCT,TRNS,   4,   5,   6,TRNS,TRNS,TRNS,     PENT,      \
